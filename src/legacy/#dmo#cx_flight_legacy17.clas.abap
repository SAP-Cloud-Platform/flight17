CLASS /dmo/cx_flight_legacy17 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_17',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_17',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id17 OPTIONAL
        booking_id            TYPE /dmo/booking_id17 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id17 OPTIONAL
        agency_id             TYPE /dmo/agency_id17 OPTIONAL
        customer_id           TYPE /dmo/customer_id17 OPTIONAL
        carrier_id            TYPE /dmo/carrier17-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_17-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_17-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date17 OPTIONAL
        end_date              TYPE /dmo/end_date17 OPTIONAL
        booking_date          TYPE /dmo/booking_date17 OPTIONAL
        flight_date           TYPE /dmo/flight_date17 OPTIONAL
        status                TYPE /dmo/travel_status17 OPTIONAL
        currency_code         TYPE /dmo/currency_code17 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id17,
          mv_booking_id            TYPE /dmo/booking_id17,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id17,
          mv_agency_id             TYPE /dmo/agency_id17,
          mv_customer_id           TYPE /dmo/customer_id17,
          mv_carrier_id            TYPE /dmo/carrier17-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_17-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_17-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date17,
          mv_end_date              TYPE /dmo/end_date17,
          mv_booking_date          TYPE /dmo/booking_date17,
          mv_flight_date           TYPE /dmo/flight_date17,
          mv_status                TYPE /dmo/travel_status17,
          mv_currency_code         TYPE /dmo/currency_code17,
...
CLASS /dmo/cx_flight_legacy17 IMPLEMENTATION.
