...
*"        /DMO/IF_FLIGHT_LEGACY17=>TT_BOOKING_SUPPLEMENT_INX OPTIONAL
*"  EXPORTING
...
*"----------------------------------------------------------------------
  ...
  /dmo/cl_flight_legacy17=>get_instance( )->update_travel( EXPORTING is_travel              = is_travel
