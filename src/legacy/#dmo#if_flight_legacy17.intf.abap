...
INTERFACE /dmo/if_flight_legacy17
  PUBLIC.
...
******************************
  ...
  "! Table type of the table /DMO/TRAVEL17
  TYPES tt_travel             TYPE SORTED TABLE OF /dmo/travel17     WITH UNIQUE KEY travel_id.
  "! Table type of the table /DMO/BOOKING17
  TYPES tt_booking            TYPE SORTED TABLE OF /dmo/booking17    WITH UNIQUE KEY travel_id  booking_id.
  "! Table type of the table /DMO/BOOK_SUP_17
  TYPES tt_booking_supplement TYPE SORTED TABLE OF /dmo/book_sup_17 WITH UNIQUE KEY travel_id  booking_id  booking_supplement_id.
  "! Table type of the table /DMO/FLIGHT17
  TYPES tt_flight TYPE STANDARD TABLE OF /dmo/flight17 WITH KEY client carrier_id connection_id flight_date.
...
******************
  ...
  TYPES travel_id TYPE /dmo/travel_id17.
  ...
  TYPES booking_id TYPE /dmo/booking_id17.
  ...
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id17.
...
* IMPORTANT: When you add or remove fields from /DMO/TRAVEL17, /DMO/BOOKING17, /DMO/BOOK_SUP_17 you need to change the following types *
***********************************************************************************************************************************
...
**********************************************************************
  ...
  INCLUDE TYPE ts_travel_key.
  TYPES action_code TYPE /dmo/action_code17.
...
*********
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM action_code_enum STRUCTURE action_code BASE TYPE /dmo/action_code17,
  ...
  TYPES:
    ...
    "! </ul>
    BEGIN OF ENUM travel_status_enum STRUCTURE travel_status BASE TYPE /dmo/travel_status17,
      initial   VALUE IS INITIAL,
      new       VALUE 'N',
      planned   VALUE 'P',
      booked    VALUE 'B',
...
************************
  ...
  INCLUDE TYPE ts_travel_key.
  INCLUDE TYPE /dmo/travel17_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id17.
  INCLUDE TYPE /dmo/booking17_data.
  ...
  TYPES booking_id TYPE /dmo/booking_id17.
  TYPES booking_supplement_id TYPE /dmo/booking_supplement_id17.
  INCLUDE TYPE /dmo/book_sup_17_data.
